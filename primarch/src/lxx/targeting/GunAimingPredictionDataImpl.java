...
public class GunAimingPredictionDataImpl implements AimingPredictionData {

    private final List<PatternTreeGun.TurnPrediction> predictedPoses;
    private final APoint predictedFirePosition;

    public GunAimingPredictionDataImpl(List<PatternTreeGun.TurnPrediction> predictedPoses, APoint predictedFirePosition) {
    ...
    private void drawPredictedPath(LXXGraphics g) {
        ...
        for (final PatternTreeGun.TurnPrediction pnt : predictedPoses) {
