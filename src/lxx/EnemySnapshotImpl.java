...
public class EnemySnapshotImpl extends RobotSnapshot2 {

    private final long lastDirChangeTime;
    private final List<Double> visits;
    private final double turnRateRadians;

    public EnemySnapshotImpl(LXXRobot2 currentState, List<Double> visits) {
        super(currentState);
        this.visits = visits;
        lastDirChangeTime = 0;
        turnRateRadians = 0;
    ...
    public EnemySnapshotImpl(EnemySnapshotImpl prevState, LXXRobot2 currentState) {
    ...
    public EnemySnapshotImpl(EnemySnapshotImpl state1, EnemySnapshotImpl state2, double interpolationK) {
