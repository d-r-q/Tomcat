...
public abstract class RoboGraphic {
    ...
    public static RoboGraphic drawLine(Point2D.Double p1, Point2D.Double p2,
                                       Color color) {
        return new RoboGraphic.Line(p1, p2, color);
    }

    public static RoboGraphic drawCircle(Point2D.Double center, double radius,
                                         Color color) {
    ...
    public static RoboGraphic drawCircleFilled(Point2D.Double p1, Color color,
                                               int radius) {
        return new RoboGraphic.Dot(p1, color, radius);
    }

    public static RoboGraphic drawText(String text, double x, double y,
                                       Color color) {
        return new RoboGraphic.Text(text, x, y, color);
    }

    public static RoboGraphic[] drawRectangle(Point2D.Double p1, double x,
    ...
    public static RoboGraphic[] drawArrowHead(Point2D.Double p1, double length,
                                              double angle, Color color) {
        RoboGraphic[] lines = new RoboGraphic[2];
        lines[0] = RoboGraphic.drawLine(p1,
                DiaUtils.project(p1, angle - 2.7, length), color);
        lines[1] = RoboGraphic.drawLine(p1,
                DiaUtils.project(p1, angle + 2.7, length), color);
        return lines;
    }
